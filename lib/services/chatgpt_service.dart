  ...
  static List<QuickAction> getFinancialQuickActions() {
    return [
      QuickAction(
        ...
        prompt:
            'Provide a detailed risk distribution of all applicants, including segments such as low, medium, and high risk, along with key risk indicators.',
        icon: '🔴',
      ...
      QuickAction(
        ...
        prompt:
            'Explain the different business types and customer segments eligible for loans, along with their typical loan approaches, risk profiles, and evaluation criteria.',
        icon: '📊',
        category: 'Portfolio',
      ),
      ...
      QuickAction(
        ...
        prompt:
            'Analyze our loan approval rates by category, risk level, and time period. Identify patterns and improvement opportunities.',
        icon: '✅',
